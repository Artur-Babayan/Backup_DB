...
class Car(models.Model):
    ...
    car_type = models.CharField(max_length=6)
...
class Muft(models.Model):
    muft_name = models.CharField(primary_key=True, max_length=255)
...
class OtherDevice(models.Model):
    other_device_name = models.CharField(primary_key=True, max_length=255)
...
class ServiceLinkMeasure(models.Model):
    service_link_measure_name = models.CharField(primary_key=True, max_length=255)

    class Meta:
        managed = False
        db_table = 'service_link_measure'
...
class Splinter(models.Model):
    splinter_name = models.CharField(primary_key=True, max_length=255)
